...
class ChatMessage(models.Model):
    ...
    sendId = models.ForeignKey(db_column='send_id', to=User, to_field='userId', related_name='send_id_fk', on_delete=models.CASCADE)
    receiveId = models.ForeignKey(db_column='receive_id', to=User, to_field='userId', related_name='receive_id_fk', on_delete=models.CASCADE)
